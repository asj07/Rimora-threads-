...
const products: Product[] = [
  {
    id: 5,
    name: 'Mermaid Open Back V-neck Long Lace Wedding Dresses',
    price: 80,
    rating: 4,
  ...
  {
    id: 6,
    name: 'Embroidered Collar Art Silk Asymmetric Sherwani In Grey',
    price: 50,
    rating: 5,
  ...
  {
    id: 7,
    name: 'Black Kurta Pajama & Embroidered Jacket For Men',
    price: 80,
    rating: 5,
  ...
  {
    id: 8,
    name: 'Ice Blue Jacquard Silk Indowestern Sherwani Wedding',
    price: 44,
    originalPrice: 70,
    rating: 4,
...
export default function NewArrivals() {
  ...
  return (
    <section
      ref={sectionRef}
      id="new-arrivals"
      className="relative bg-[#F6F2EE] py-16 lg:py-24 z-70"
    >
      <div className="section-padding">
        {/* Header */}
        <div className="arrivals-header mb-12">
          <p className="text-micro text-[#6B7280] mb-3">NEW ARRIVAL</p>
          <h2 className="heading-lg font-serif text-[#111827]">Latest Products</h2>
        </div>
